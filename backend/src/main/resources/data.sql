...
('Villa de Leyva', 'Pueblo colonial reconocido por su arquitectura y calles empedradas', '4 horas', 'EXTERIOR', 'Villa de Leyva', 'Boyaca', 'Colombia', 5.6349, -73.5248),
...
('https://travesia360.com/wp-content/uploads/2021/10/villa-de-leyva-gobernacion-boyaca.jpg',
...
('Boyaca Colonial',
 ...
 180000, 'EXTERIOR',
 'Villa de Leyva','Boyaca','Colombia', 5.6349, -73.5248,
 'Villa de Leyva','Boyaca','Colombia', 5.6349, -73.5248),
...
UPDATE tours SET album_id = (SELECT id FROM albums WHERE name = 'Boyaca Colonial') WHERE name = 'Boyaca Colonial';
...
('https://upload.wikimedia.org/wikipedia/commons/6/65/Tayrona_National_Natural_Park.jpg',
...
('https://upload.wikimedia.org/wikipedia/commons/5/5c/Villa_de_Leyva.jpg',
 'Calles coloniales de Boyaca',
 (SELECT id FROM albums WHERE name = 'Boyaca Colonial')),
...
((SELECT id FROM tours WHERE name = 'Boyaca Colonial'), 150000),
...
((SELECT id FROM tours WHERE name = 'Boyaca Colonial'),
