...
class TouristPlaceServiceTest {
    ...
    void setUp() {
        ...
        place.setId(1L);
        place.setName("Cerro Quitasol");
        place.setDescription("Hermoso cerro");
        place.setEnvironment(Environment.EXTERIOR);
    ...
    void getAll_returnsAllPlaces() {
        ...
        List<TouristPlaceResponse> result =
                touristPlaceService.getAll();

        assertThat(result).hasSize(1);
        assertThat(result.get(0).getName())
                .isEqualTo("Cerro Quitasol");
    }
    ...
    void getById_returnsPlaceIfFound() {
        ...
        TouristPlaceResponse result =
                touristPlaceService.getById(1L);
    ...
    void getByName_returnsMatchingPlaces() {
        ...
        when(placeRepository.findByNameContainingIgnoreCase("cerro"))
                .thenReturn(List.of(place));

        List<TouristPlaceResponse> result =
                touristPlaceService.getByName("cerro");
    ...
    void getByName_returnsEmptyIfNoMatch() {
        ...
        when(placeRepository.findByNameContainingIgnoreCase("xyz"))
                .thenReturn(List.of());

        List<TouristPlaceResponse> result =
                touristPlaceService.getByName("xyz");
    ...
    void getByCity_returnsPlacesInCity() {
        ...
        when(placeRepository.findByLocationCityIgnoreCase("Tunja"))
                .thenReturn(List.of(place));

        List<TouristPlaceResponse> result =
                touristPlaceService.getByCity("Tunja");
    ...
    void getByEnvironment_returnsMatchingPlaces() {
        ...
        when(placeRepository.findByEnvironment(Environment.EXTERIOR))
                .thenReturn(List.of(place));

        List<TouristPlaceResponse> result =
                touristPlaceService.getByEnvironment(Environment.EXTERIOR);

        assertThat(result).hasSize(1);
        assertThat(result.get(0).getEnvironment())
                .isEqualTo(Environment.EXTERIOR);
    }
    ...
    void create_savesPlaceSuccessfully() {
        ...
        TouristPlace savedPlace = new TouristPlace();
        savedPlace.setId(2L);
        savedPlace.setName("Lago de Tota");
        savedPlace.setEnvironment(Environment.EXTERIOR);
        savedPlace.setActivities(new ArrayList<>());
        savedPlace.setCategories(new ArrayList<>());
        savedPlace.setAlbum(null);
    ...
    void create_assignsCategoriesWhenProvided() {
        ...
        TouristPlace savedPlace = new TouristPlace();
        savedPlace.setId(3L);
        savedPlace.setName("Cascada");
        savedPlace.setActivities(new ArrayList<>());
        savedPlace.setCategories(new ArrayList<>(List.of(category)));
        savedPlace.setAlbum(null);
    ...
    void create_throwsIfCategoryNotFound() {
        ...
        Long badCategoryId = 99L;

        TouristPlaceRequest request = new TouristPlaceRequest();
        request.setName("Lugar X");
        request.setCategoryIds(List.of(badCategoryId));

        when(categoryRepository.findById(badCategoryId))
                .thenReturn(Optional.empty());
    ...
    void update_throwsIfPlaceNotFound() {
        ...
        assertThatThrownBy(() ->
                touristPlaceService.update(1L, request))
                .isInstanceOf(TouristPlaceNotFoundException.class);
    }
    ...
    void update_updatesAndReturnsPlace() {
        ...
        realPlace.setCategories(new ArrayList<>());
        realPlace.setActivities(new ArrayList<>());
        ...
        when(placeRepository.findById(1L))
                .thenReturn(Optional.of(realPlace));
        ...
        assertThat(result.getName())
                .isEqualTo("Quitasol Actualizado");
    }
    ...
    void resolveOrThrow_returnsPlace() {
        ...
        TouristPlace result =
                touristPlaceService.resolveOrThrow(1L);
